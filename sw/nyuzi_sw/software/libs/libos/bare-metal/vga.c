...
/**
 * @brief       Switches the framebuffer base address of the VGA controller
 * @param fb    defines which framebuffer should be used.
 *              1 = first framebuffer
 *              2 = second framebuffer
 * @return      The address of the active framebuffer or 0 in case of an error
 */
void *switch_fb(int fb)
{
    void *res = 0;
    switch (fb)
    {
        ...
        case 2:
            ...
            //REGISTERS[REG_VGA_ENABLE] = 0;
            REGISTERS[REG_VGA_BASE] = FB_BASE2;
            //REGISTERS[REG_VGA_ENABLE] = 1;
            res = (void*) FB_BASE2;
            break;

        case 3:
			/* Use third framebuffer */
			//REGISTERS[REG_VGA_ENABLE] = 0;
			REGISTERS[REG_VGA_BASE] = FB_BASE3;
			//REGISTERS[REG_VGA_ENABLE] = 1;
			res = (void*) FB_BASE3;
			break;
